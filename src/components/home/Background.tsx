    ...
    <Section id="background">
      ...
      <div className="grid gap-block lg:grid-cols-12 lg:gap-16">
        <div className="lg:col-span-5">
          ...
          <p
            className="mt-5 max-w-prose text-body text-ink-2"
            {...reveal(1)}
          >
          ...
          <Link
            href="/about"
            className="group mt-8 inline-block text-small text-accent-text underline decoration-1 underline-offset-4 hover:decoration-2"
            {...reveal(2)}
          >
